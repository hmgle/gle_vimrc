...
" 弹出菜单颜色
hi Pmenu        ctermfg=74          ctermbg=233         cterm=None
" hi PmenuSel     ctermfg=122         ctermbg=232         cterm=Bold
hi PmenuSel     ctermfg=122         ctermbg=233         cterm=Bold
...
hi TabLineSel   ctermfg=74         ctermbg=232         cterm=Bold
" 匹配的括号颜色
hi MatchParen   ctermfg=184         ctermbg=235         cterm=bold,underline

" 语法检查错误的颜色
hi clear SpellBad
hi SpellBad  ctermfg=196  ctermbg=16  cterm=None
hi clear SpellRare                                               
" hi SpellRare cterm=underline                                     
hi SpellRare ctermfg=220 ctermbg=16  cterm=underline
hi clear SpellCap                                                
hi SpellCap ctermfg=196 ctermbg=16 cterm=underline                                      
hi clear SpellLocal
hi SpellLocal ctermfg=210 ctermbg=16 cterm=None
